...
// Project related.
var project                 = 'BMStarter'; // Project Name.
var projectURL              = 'http://localhost/bm-page-builder'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'bm-starter'; // Your textdomain here.
...
var packageName             = 'bm-starter'; // Package name.
...
var cssVendorFile            = 'vendors'; // Compiled CSS vendors file name.
...
// JS Custom related.
var jsCustomSRC             = './assets/js/custom/partials/theme.js'; // Path to JS custom scripts folder.
...
var vendorCSSWatchFiles      = './assets/css/vendor/*.css'; // Path to all vendor JS files.
